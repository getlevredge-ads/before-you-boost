...
export default function AdReadinessTracker() {
    ...
    if (answers.closingMethod === 'unsure') {
      setResult({
        ...
        steps: [
          ...
          { num: 2, task: 'Set up 3 auto-replies', detail: '"Thanks for your interest. What would you like to know?" + product details + payment method. See templates below.' },
  ...
  // Calculate cost-per-sale and benchmarks
  const calculateBenchmark = () => {
    ...
    const benchmarkCPS = basePrice * 0.2; // 20% of product price is a healthy CPS
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex gap-3 mt-8">
            ...
            <button
              ...
              disabled={!answers.organicSales || (answers.organicSales === 'yes' && !answers.closingMethod) || (answers.closingMethod && !answers.closingMethod.includes('unsure') && answers.closingMethod !== 'unsure' && !answers.budget)}
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-800 p-6">
        <div className="max-w-2xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-slate-400 text-sm">4 quick questions about your offer & market. Then we'll give you your verdict.</p>
          </div>
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-900 to-slate-800 p-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={() => alert('Join our community for weekly reviews and live support. Coming soon!')}
